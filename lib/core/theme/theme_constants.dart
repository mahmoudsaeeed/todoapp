...
//* Fonts
const double headLineLargeFont = 26;
const double headLineMediumFont = 20;
const double displayMediumFont = 16;


//* Radius
const double taskTileBorderRadius = 10;
const double taskPartBorderRadiusInTop = 30;
